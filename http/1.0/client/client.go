...
func (c *Client) Do(ctx context.Context, r http1_0.Request) (http1_0.Response, error) {
	...
	case *http1_0.SimpleRequest:
		...
		return resp, nil
	case *http1_0.FullRequest:
		resp, err := c.doFullRequest(ctx, r)
		if err != nil {
			return nil, fmt.Errorf("failed to do: %s", err)
		}
		return resp, nil
...
func (c *Client) doFullRequest(ctx context.Context, r *http1_0.FullRequest) (*http1_0.FullResponse, error) {
	assureFullRequest(r)
